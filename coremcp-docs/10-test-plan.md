...
| Multi-MCP hardening | pass | tool namespace prefix, resource catalog miss no-broadcast, duplicate URI shadow policy, HTTP downstream session mapping/TTL/invalidation |
